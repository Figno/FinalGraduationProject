package com.chxip.localmusic.view.gridView;
...
/*    // // 上拉的箭头
    ...
    private void initView(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        defaultRefreshView = inflater.inflate(R.layout.pull_to_refresh_header, this,
                false);
        refreshView = defaultRefreshView;
        defaultLoadmoreView = inflater.inflate(R.layout.listview_footer, this, false);
            ...
            public void run()
            {
                ...
                switch (refreshResult)
                {
                    case SUCCEED:
                        // 刷新成功
                        if (null == customRefreshView) {
                            lastUpdate.setText(getContext().getString(R.string.lastUpdateTime, Utils.getCurrentTime()));
                        }
                        break;
                    case FAIL:
                    default:
                        // 刷新失败
                        if (null == customRefreshView) {
                            lastUpdate.setText(getContext().getString(R.string.lastUpdateTime,
    ...
    private void initView()
    {
        ...
        if (null == customRefreshView)
        {
            pullDownView = defaultRefreshView.findViewById(R.id.arrow);
            refreshStateTextView = (TextView) defaultRefreshView
                    .findViewById(R.id.tip);
            refreshingView = defaultRefreshView.findViewById(R.id.refreshing);
            refreshingView.setVisibility(View.GONE);
            lastUpdate= (TextView) defaultRefreshView.findViewById(R.id.lastUpdate);
            lastUpdate.setText(getContext().getString(R.string.lastUpdateTime,Utils.getCurrentTime()));
